...
export default function InquiryForm({ propertyId, propertyTitle, nightlyPrice }: InquiryFormProps) {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 shadow-[0_24px_80px_rgba(20,20,20,0.08)] ring-1 ring-black/5 sticky top-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full border border-black/10 bg-[#F8F8F8] px-3 py-3 text-sm text-[#141414] outline-none transition-colors focus:border-[#141414] min-h-[44px]"
            />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea
            ...
            minLength={10}
            rows={4}
            className="mt-1 w-full border border-black/10 bg-[#F8F8F8] px-3 py-3 text-sm text-[#141414] outline-none transition-colors focus:border-[#141414] min-h-[100px]"
