...
export function PropertyMap({
  ...
  if (properties.length === 0) {
    return (
      <div className={`w-full h-[300px] sm:h-[400px] lg:h-[500px] flex items-center justify-center bg-gray-50 rounded-lg ${className}`}>
  ...
  return (
    <div className={`relative w-full h-[300px] sm:h-[400px] lg:h-[500px] rounded-lg overflow-hidden ${className}`}>
